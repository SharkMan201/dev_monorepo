load("//third_party/vulkan/platform:windows.bzl", "vulkan_windows")
load("//third_party/vulkan/platform:linux.bzl", "vulkan_linux")
load("//third_party/vulkan/platform:macos.bzl", "vulkan_macos")
load("//third_party/vulkan/platform:android.bzl", "vulkan_android")
