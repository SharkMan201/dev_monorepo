import pathlib
from logo_automation.opencv_manager import embedWatermark, displayImage, writeImage
from logo_automation.local_paths import get_local_path
...
inputDir = get_local_path('_main/logo_automation/input')
outputDir = get_local_path('_main/logo_automation/output')
logoImagePath = get_local_path('_main/logo_automation/assets/logo-no-background-cropped-light-grey.png')
offsetX = 200
offsetY = 200
opacity = 0.4
spacing = 1.8
